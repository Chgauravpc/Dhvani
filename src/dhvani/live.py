...
Requires `GROQ_API_KEY` in the environment. Downloads faster-whisper's model
and the pinned Piper voice on first run if not already cached (see
`docs/specs/phase-1.md`). Then open http://localhost:8080/ in a browser,
grant microphone access, and talk.
